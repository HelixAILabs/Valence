...
> **Updating from 1.0.2 or earlier?** The old in-app updater can't install this fix on its own, please [update to 1.0.3 manually](/2026/06/26/update-to-1-0-3-manually.html) just this once. After that, in-app updates work normally.
